...
function md5_vm_test() {
        ...
        function core_md5(p, k) {
            p[k >> 5] |= 128 << ((k) % 32); p[(((k + 64) >>> 9) << 4) + 14] = k;
            var o = 1732584193;
            var n = -271733879;
            var m = -1732584194;
            var l = 271733878;
...
function m(){
    var timeTemp = Date.parse(new Date()) + (16798545 + -72936737 + 156138192)
	var mm = '' + hex_md5(timeTemp.toString());
	var m = mm + "%E4%B8%A8" + timeTemp/1000
    return m
}